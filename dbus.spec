...
Source0  : https://dbus.freedesktop.org/releases/dbus/dbus-1.10.22.tar.gz
...
%prep
%setup -q -n dbus-1.10.22
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a dbus-1.10.22 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1501247313
...
/usr/lib64/libdbus-1.so.3.14.13

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libdbus-1.so.3
/usr/lib32/libdbus-1.so.3.14.13
