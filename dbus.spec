...
Source0  : https://dbus.freedesktop.org/releases/dbus/dbus-1.14.6.tar.xz
Source1  : https://dbus.freedesktop.org/releases/dbus/dbus-1.14.6.tar.xz.asc
...
%prep
%setup -q -n dbus-1.14.6
cd %{_builddir}/dbus-1.14.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a dbus-1.14.6 build32
popd
pushd ..
cp -a dbus-1.14.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683565004
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/dbus-cleanup-sockets
/V3/usr/bin/dbus-daemon
/V3/usr/bin/dbus-launch
/V3/usr/bin/dbus-monitor
/V3/usr/bin/dbus-run-session
/V3/usr/bin/dbus-send
/V3/usr/bin/dbus-test-tool
/V3/usr/bin/dbus-update-activation-environment
/V3/usr/bin/dbus-uuidgen
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdbus-1.so.3
/V3/usr/lib64/libdbus-1.so.3.32.2
/usr/lib64/libdbus-1.so.3
/usr/lib64/libdbus-1.so.3.32.2

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libdbus-1.so.3
/usr/lib32/libdbus-1.so.3.32.2
