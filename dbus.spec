...
Source0  : https://dbus.freedesktop.org/releases/dbus/dbus-1.14.10.tar.xz
Source1  : https://dbus.freedesktop.org/releases/dbus/dbus-1.14.10.tar.xz.asc
Source2  : E05AE1478F814C4F.pkey
...
%setup -q -n dbus-1.14.10
cd %{_builddir}/dbus-1.14.10
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a dbus-1.14.10 build32
popd
pushd ..
cp -a dbus-1.14.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740763448
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libdbus-1.so.3.32.4
/usr/lib64/libdbus-1.so.3
/usr/lib64/libdbus-1.so.3.32.4
